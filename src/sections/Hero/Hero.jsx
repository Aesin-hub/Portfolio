    ...
    <section id="hero" className={styles.hero}>
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          ...
          {/* Partie Gauche : Nom + Texte + Boutons + Social */}
          <div className={styles.textContent}>
            {/* Nom */}
            <h1 className={styles.title}>Lewis Bock</h1>
            ...
            <div className={styles.social}>
              <a 
                href="https://github.com/Aesin-hub" 
                target="_blank" 
                rel="noopener noreferrer"
                className={styles.socialLink}
                aria-label="Profil GitHub de Lewis Bock"
              ...
              <a 
                href="https://www.linkedin.com/in/lewis-bock-055051177/" 
                target="_blank" 
                rel="noopener noreferrer"
                className={styles.socialLink}
                aria-label="Profil LinkedIn de Lewis Bock"
          ...
          <div className={styles.imageWrapper}>
            <img 
              ...
              alt="Illustration 3D isométrique d'un workspace de développeur front-end avec ordinateur, plantes et accessoires tech"
              title="Workspace moderne de Lewis Bock, développeur front-end React"
