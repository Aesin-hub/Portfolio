...
function Footer() {
  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.container}>
        ...
        <div className={styles.column}>
          ...
          <p className={styles.description}>
            Développeur Frontend passionné, je crée des interfaces web performantes et accessibles.
          </p>
        </div>
        ...
        <div className={styles.column}>
          <h3 className={styles.columnTitle}>Suivez-moi</h3>
          <div className={styles.social}>
            <a href="https://github.com/Aesin-hub" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://www.linkedin.com/in/lewis-bock-055051177/" target="_blank" rel="noopener noreferrer">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      ...
      {/* Barre du bas : Copyright + Bouton scroll to top */}
      <div className={styles.bottom}>
        <div className={styles.container}>
          <p className={styles.copyright}>
            © 2025 Lewis Bock. Tous droits réservés.
          </p>
