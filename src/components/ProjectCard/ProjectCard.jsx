    ...
    >
      ...
      <div className={styles.imageContainer}>
        <img 
          ...
          alt={project.altText || `Capture d'écran du projet ${project.title}`}
          title={`Projet ${project.title} - ${project.tags.slice(0, 2).join(' & ')}`}
      ...
      {/* Bouton "Voir le projet" au centre de la carte (visible au hover) */}
      {isHovered && (
